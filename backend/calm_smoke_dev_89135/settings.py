"""
Django settings for calm_smoke_dev_89135 project.
...
ROOT_URLCONF = 'calm_smoke_dev_89135.urls'
...
WSGI_APPLICATION = 'calm_smoke_dev_89135.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_smoke_dev_89135 API",
    "DESCRIPTION": "API documentation for calm_smoke_dev_89135 App",
    "VERSION": "v1",
}
